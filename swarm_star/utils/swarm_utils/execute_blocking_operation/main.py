...
from swarm_star.swarm.types import Swarm, SwarmNode, NodeOutput, BlockingOperation, ActionSpace
...
def execute_blocking_operation(swarm: Swarm, blocking_operation: BlockingOperation) -> Union[NodeOutput, BlockingOperation]:
    ...
    blocking_operation_type_map = {
        'openai_instructor_completion': 'swarm_star.utils.action_utils.execute_blocking_operation.openai_instructor_completion',
        'internal_action': 'swarm_star.utils.action_utils.execute_blocking_operation.internal_action'
    }
