...
platform_map = {
    'mac': 'swarm_star.utils.data.folder_operations.local_storage',
    'azure': 'swarm_star.utils.data.folder_operations.azure_blob_storage',
}
...
def move_swarm_space_folder(swarm: SwarmConfig, folder_path: str, new_folder_path: str) -> None:
    platform = swarm.platform
    folder_path = validate_and_adjust_swarm_space_path(folder_path, swarm.swarm_space_root_path)
...
def rename_swarm_space_folder(swarm: SwarmConfig, folder_path: str, new_folder_name: str) -> None:
    platform = swarm.platform
    folder_path = validate_and_adjust_swarm_space_path(folder_path, swarm.swarm_space_root_path)
