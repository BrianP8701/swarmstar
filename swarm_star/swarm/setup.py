...
from swarm_star.swarm.types import SwarmConfig, LocalConfig, AzureConfig
from swarm_star.utils.data.kv_operations.mongodb import restore_database, check_and_create_database
from swarm_star.utils.data.kv_operations.main import add_kv

def configure_swarm(openai_key: str, root_path: str, platform: str, **kwargs) -> SwarmConfig:
    try:
...
def _setup_mac_swarm_space(openai_key: str, root_path: str, **kwargs) -> SwarmConfig:
    ...
    restore_database('swarm_star/metadata', kwargs['mongodb_uri'], kwargs['mongodb_db_name'])
