...
def execute_blocking_operation(swarm: Swarm, blocking_operation: BlockingOperation) -> Union[NodeOutput, BlockingOperation]:
    ...
    blocking_operation_type_map = {
        'openai_instructor_completion': 'tree_swarm.utils.action_utils.execute_blocking_operation.openai_instructor_completion',
        'internal_action': 'tree_swarm.utils.action_utils.execute_blocking_operation.internal_action'
    }
