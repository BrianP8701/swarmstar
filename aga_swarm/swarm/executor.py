...
def execute_action(action_id: str, swarm_config: SwarmConfig, params: Dict[str, Any]) -> Dict[str, Any]:
    '''
    ...
    '''
    action_space_metadata = swarm_config.get_action_space_metadata()
