...
def delete_swarm_space_folder(swarm: Swarm, folder_path: str) -> dict:
...
def list_swarm_space_folder(swarm: Swarm, folder_path: str) -> dict:
    platform = swarm.platform.value
    folder_path = validate_and_adjust_swarm_space_path(folder_path, swarm.swarm_space_root_path)
    folder_operations_module = import_module(platform_map[platform])
    return folder_operations_module.list_folder(swarm, folder_path)

def make_swarm_space_folder(swarm: Swarm, folder_path: str) -> dict:
    platform = swarm.platform.value
    folder_path = validate_and_adjust_swarm_space_path(folder_path, swarm.swarm_space_root_path)
    folder_operations_module = import_module(platform_map[platform])
    return folder_operations_module.make_folder(swarm, folder_path)

def move_swarm_space_folder(swarm: Swarm, folder_path: str, new_folder_path: str) -> dict:
    platform = swarm.platform.value
    folder_path = validate_and_adjust_swarm_space_path(folder_path, swarm.swarm_space_root_path)
...
def rename_swarm_space_folder(swarm: Swarm, folder_path: str, new_folder_name: str) -> dict:
    platform = swarm.platform.value
    folder_path = validate_and_adjust_swarm_space_path(folder_path, swarm.swarm_space_root_path)
