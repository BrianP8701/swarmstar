...
def delete_swarm_space_file(swarm: Swarm, file_path: str) -> dict:
...
def move_swarm_space_file(swarm: Swarm, file_path: str, new_file_path: str) -> dict:
    platform = swarm.platform.value
    file_path = validate_and_adjust_swarm_space_path(file_path, swarm.swarm_space_root_path)
...
def rename_swarm_space_file(swarm: Swarm, file_path: str, new_file_name: str) -> dict:
    platform = swarm.platform.value
    file_path = validate_and_adjust_swarm_space_path(file_path, swarm.swarm_space_root_path)
...
def upload_swarm_space_file(swarm: Swarm, file_path: str, file_bytes: bytes) -> dict:
    platform = swarm.platform.value
    file_path = validate_and_adjust_swarm_space_path(file_path, swarm.swarm_space_root_path)
    file_operations_module = import_module(platform_map[platform])
    return file_operations_module.upload_file(swarm, file_path, file_bytes)

def retrieve_swarm_space_file(swarm: Swarm, file_path: str) -> dict:
    platform = swarm.platform.value
    file_path = validate_and_adjust_swarm_space_path(file_path, swarm.swarm_space_root_path)
    file_operations_module = import_module(platform_map[platform])
