...
def test_setup_swarm_space():
    ...
    setup_swarm_space(
        ...
        "testing/test1/",
        "azure",
        azure_cosmos_db_url=azure_cosmos_db_url,
        azure_cosmos_db_key=azure_cosmos_db_key,
        azure_cosmos_db_database_name=azure_cosmos_db_database_name,
        azure_cosmos_db_container_name=azure_cosmos_db_container_name,
